...
- Luotu GitHub io -sivusto testien tulosten katseluun. [GitHub io -sivustolle](https://jespesa.github.io/). Hyperlinkki Logi tiedostoon [Log.html](https://github.com/Jespesa/hyte-backend-exercises/blob/ohjelmistotestaus/tests/outputs/log.html) ja Report tiedostoon [Report.html](https://github.com/Jespesa/hyte-backend-exercises/blob/ohjelmistotestaus/tests/outputs/report.html)
